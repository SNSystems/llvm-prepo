...
get(llvm::repo::SparseArray<ValueType, BitmapType> &Arr) noexcept {
  static_assert(Ip < llvm::repo::SparseArray<ValueType, BitmapType>::max_size(),
...
get(llvm::repo::SparseArray<ValueType, BitmapType> const &Arr) noexcept {
  static_assert(Ip < llvm::repo::SparseArray<ValueType, BitmapType>::max_size(),
