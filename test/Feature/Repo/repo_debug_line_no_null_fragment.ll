; Check that no NullFragment is writing to the database.
;
; RUN: rm -f %t.db
; RUN: env REPOFILE=%t.db opt -S -mtriple x86_64-pc-linux-gnu-repo %s -o %t 2>&1
...
;CHECK-NOT: fragment 00000000000000000000000000000000 adding
