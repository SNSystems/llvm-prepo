...
!1 = !TicketNode(name: "fact3", digest: [16 x i8] c"\CA\FC.\06\8A\84\BE\14 \CB\7F5J\22l\19", linkage: external, isComdat: false)

;CHECK: ticket name {{[0-9]+}} digest db763cb3013dcfa32f9e1d903868542b adding.
;CHECK: ticket name {{[0-9]+}} digest 196c224a357fcb2014be848a062efcca adding.
